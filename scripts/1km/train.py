...
# Note: train sampler balance feature removed. Previously a
# _build_splot_balanced_sampler() helper constructed a
# WeightedRandomSampler to oversample chips containing positive
# labels for a given dataset. That behavior has been intentionally
# removed to keep training deterministic and simpler.


@hydra.main(
    config_path="../../config/1km", config_name="training/default", version_base=None
)
def main(cfg: DictConfig) -> None:
    console.rule("[bold cyan]TRAINING 1KM[/bold cyan]")
    ...
    # Sampling balance intentionally disabled/removed.
    # The training loader created above (`train_loader`) is used as-is.
