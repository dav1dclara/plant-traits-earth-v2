...
Usage:
    ...
    python scripts/1km/convert_zarr_to_hdf5.py --no-compress        # skip gzip
...
def main() -> None:
    ...
    parser.add_argument(
        "--no-compress",
        action="store_true",
        help="Disable gzip level-1 compression (larger files, no decompression overhead)",
    )
    ...
    for split in args.splits:
        ...
        convert_split(zarr_path, h5_path, compress=not args.no_compress)
